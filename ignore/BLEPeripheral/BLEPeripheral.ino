...
BLECharCharacteristic characteristic = BLECharCharacteristic("fff1", BLERead | BLEWrite | BLENotify);
...
void setup() {
  ...
  blePeripheral.setLocalName("Bear");
blePeripheral.setDeviceName("Bear");
